...
export default function EmailHeader({ email, submittedCount, onLogout }: EmailHeaderProps) {
  return (
    <div className="flex items-center justify-between gap-3 p-4 rounded-xl bg-slate-800/30 border border-slate-700/50">
      ...
      <button
        type="button"
        onClick={onLogout}
        className="flex items-center gap-1.5 text-sm text-slate-400 hover:text-red-400 transition-colors flex-shrink-0"
      >
