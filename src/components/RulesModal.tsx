        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide p-8 pt-6 space-y-6">
          ...
          <section>
            ...
            <ul className="space-y-2 text-slate-300 text-sm leading-relaxed">
              ...
              <li className="flex gap-3">
                <span className="text-blue-400 shrink-0 leading-relaxed">→</span>
                <span>Submissions open <strong className="text-white">{ENTRY_CONFIG.submissionWindowOpened.toLocaleString('en-US', { weekday: 'long', month: 'long', day: 'numeric', hour: 'numeric', minute: '2-digit', timeZone: 'America/Los_Angeles', timeZoneName: 'short' })}</strong></span>
              </li>
              <li className="flex gap-3">
                <span className="text-blue-400 shrink-0 leading-relaxed">→</span>
                <span>Submissions close <strong className="text-white">{ENTRY_CONFIG.submissionWindowClosed.toLocaleString('en-US', { weekday: 'long', month: 'long', day: 'numeric', hour: 'numeric', minute: '2-digit', timeZone: 'America/Los_Angeles', timeZoneName: 'short' })}</strong></span>
              </li>
              <li className="flex gap-3">
                <span className="text-blue-400 shrink-0 leading-relaxed">→</span>
